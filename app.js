 ...
 * update page when pressed and no refreshing required. There is a barcode generator that will create a barcode as you type
 * in the values.
 *
 * created 'public' folder for backend to send data to front end for use of some modules. like jQuery and jsBarCode.
 *
 ...
 *
 * TODO:
 * Login page needs to have a formulated plan and soon implementation
 * Statistics page needs a plan
 *
 * We can experiment with bootstrap or jQuery on the forms
 *
...
//static folder 'public' for front end to import from
